          ...
          {currentTab === 'profile' && (
            <div className="p-6">
              ...
              <div className="bg-slate-800 p-6 rounded-xl flex items-center space-x-4">
                <div className="w-20 h-20 bg-blue-700 rounded-full flex items-center justify-center text-2xl font-bold">
                  F
                </div>
                <div>
                  <button className="bg-blue-700 hover:bg-blue-500 px-4 py-2 rounded-full text-sm transition">
