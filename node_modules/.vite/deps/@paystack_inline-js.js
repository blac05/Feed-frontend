//#region node_modules/@paystack/inline-js/es/inline.js
function e(e, n) {
...
function t(e, n) {
	for (var t = 0; t < n.length; t++) {
		var a = n[t];
		a.enumerable = a.enumerable || !1, a.configurable = !0, "value" in a && (a.writable = !0), Object.defineProperty(e, u(a.key), a);
	}
}
function a(e, n, a) {
	return n && t(e.prototype, n), a && t(e, a), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function i(e, n, t) {
...
function c(e, n) {
	...
	if (Object.getOwnPropertySymbols) {
		...
		for (a = 0; a < o.length; a++) t = o[a], -1 === n.indexOf(t) && {}.propertyIsEnumerable.call(e, t) && (i[t] = e[t]);
	}
	return i;
}
function s(e, n) {
	return function(e) {
		...
		if (null != t) {
			var a, i, o, r, c = [], s = !0, l = !1;
			try {
				if (o = (t = t.call(e)).next, 0 === n) {
					if (Object(t) !== t) return;
					s = !1;
				} else for (; !(s = (a = o.call(t)).done) && (c.push(a.value), c.length !== n); s = !0);
			} catch (e) {
				l = !0, i = e;
			} finally {
				try {
...
function d(n, t) {
	if (n) {
		...
		return "Object" === a && n.constructor && (a = n.constructor.name), "Map" === a || "Set" === a ? Array.from(n) : "Arguments" === a || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(a) ? e(n, t) : void 0;
	}
}
var h = {
...
function f(e, n) {
	...
	return Object.keys(e).forEach(function(a) {
		var i = n ? "".concat(n, "[").concat(a, "]") : a, o = e[i];
		t.push(null !== o && "object" === ("undefined" == typeof v ? "undefined" : p(v)) ? f(o, i) : "".concat(encodeURIComponent(a), "=").concat(encodeURIComponent(o)));
	}), t.join("&");
}
function g() {
	return document.currentScript || (e = document.getElementsByTagName("script"))[e.length - 1];
	var e;
}
function b() {
	var e = [], n = g();
	if (n) {
		var t = Array.prototype.slice.call(n.attributes);
		e = Object.keys(t).filter(function(e) {
			var n = t[e].nodeName;
			return n && n.indexOf("data") > -1;
		}).map(function(e) {
			return t[e].nodeName;
		});
	}
...
var w = {
	...
	return e && "object" === p(e) ? Object.keys(w).reduce(function(n, t) {
		return r(r({}, n), {}, i({}, t, e[t] || w[t]));
	}, {}) : w;
}, M = function() {
	return Number(parseFloat((arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0) / 100).toFixed(2));
}, P = {
	headers: {
...
function V(e) {
	return Object.keys(e).reduce(function(n, t) {
		var a = encodeURIComponent(t), i = encodeURIComponent(e[t]), o = "".concat(a, "=").concat(i);
		return [].concat(l(n), [o]);
	}, []).join("&");
}
var L = function(e) {
	...
	return _() && e.includes("apple_pay");
};
function E() {
	var e = 0;
	return Array.from(document.querySelectorAll("body *")).forEach(function(n) {
		var t = window.getComputedStyle(n), a = parseFloat(t.zIndex);
		!Number.isNaN(a) && a > e && (e = a);
	}), e;
}
function A(e) {
	var n = document.createElement("iframe");
	return n.setAttribute("frameBorder", "0"), n.setAttribute("allowtransparency", "true"), n.id = e, n.style.display = "none", n;
}
function T(e) {
	return e.querySelector("apple-pay-button") || e.querySelector("#apple-pay-button");
}
function q(e) {
	return document.querySelector("#".concat(e));
}
function H(e, n, t) {
	var a = n.channels, i = void 0 === a ? [] : a, o = n.styles, r = void 0 === o ? {} : o, c = { applePay: !1 };
	return new Promise(function(n, a) {
		if (e) if (S(i)) {
			if (T(e)) return c.applePay = !0, void n(c);
			(function(e, n) {
				var t = n.container, a = n.integrity;
				return new Promise(function(n, i) {
					e || i("No script url");
					var o = document.createElement("script");
					o.src = e, o.crossOrigin = "anonymous", a && (o.integrity = a), o.addEventListener("load", function() {
						n(!0);
					}), o.addEventListener("error", function() {
						o.remove(), i(!1);
					}), t ? t.appendChild(o) : document.head.appendChild(o);
				});
			})("https://applepay.cdn-apple.com/jsapi/v1.1.0/apple-pay-sdk.js", {
				container: e,
				integrity: "sha384-z/6BVHCcSypLSykOVpaT1PQWHOOgU45uOOlMkgi/bElX4yFqmChNMb7qiv80wFav"
			}).then(function() {
				if (t && 1077497 !== t && window && !Array.isArray(window.webpackJsonp)) throw new Error("Incorrect data type for 'webpackJsonp', expected array, got ".concat(p(window.webpackJsonp), ". Switching to fallback apple pay button"));
				(function(e, n) {
					var t, a, i, o, r, c = n.styles, s = n.theme, l = document.createElement("style"), u = (a = (t = c).height, i = t.width, o = t.borderRadius, r = t.padding, "\n  apple-pay-button {\n    --apple-pay-button-width: ".concat(i, ";\n    --apple-pay-button-height: ").concat(a, ";\n    --apple-pay-button-border-radius: ").concat(o, ";\n    --apple-pay-button-padding: ").concat(r, ";\n    --apple-pay-button-box-sizing: border-box;\n    width: ").concat(i, ";\n  }\n"));
					l.type = "text/css", l.styleSheet ? l.styleSheet.cssText = u : l.appendChild(document.createTextNode(u)), e.appendChild(l);
					var p = document.createElement("apple-pay-button");
					p.setAttribute("buttonstyle", "light" === s ? "white" : "black"), p.setAttribute("type", c.type), p.setAttribute("locale", c.locale), e.appendChild(p);
				})(e, {
					styles: x(r.applePay),
					theme: r.theme
				}), c.applePay = !0, n(c);
				...
				(function(e, n) {
					var t, a, i, o, r, c, s, l = n.styles, u = n.theme, p = document.createElement("style"), d = (a = (t = l).height, i = t.width, o = t.borderRadius, r = t.padding, c = t.type, s = t.locale, "\n  @supports (-webkit-appearance: -apple-pay-button) { \n    .apple-pay-button {\n        display: inline-block;\n        -webkit-appearance: -apple-pay-button;\n        width: ".concat(i, ";\n        height: ").concat(a, ";\n        border-radius: ").concat(o, ";\n        padding: ").concat(r, ";\n        -apple-pay-button-type: ").concat(c, ";\n        -webkit-locale: ").concat(s, ";\n    }\n    .apple-pay-button-black {\n        -apple-pay-button-style: black;\n    }\n    .apple-pay-button-white {\n        -apple-pay-button-style: white;\n    }\n    .apple-pay-button-white-with-line {\n        -apple-pay-button-style: white-outline;\n    }\n  }\n\n  @supports not (-webkit-appearance: -apple-pay-button) {\n    .apple-pay-button {\n        display: inline-block;\n        background-size: 100% 60%;\n        background-repeat: no-repeat;\n        background-position: 50% 50%;\n        border-radius: 5px;\n        padding: 0px;\n        box-sizing: border-box;\n        min-width: 200px;\n        min-height: 32px;\n        max-height: 64px;\n    }\n    .apple-pay-button-black {\n        background-image: -webkit-named-image(apple-pay-logo-white);\n        background-color: black;\n    }\n    .apple-pay-button-white {\n        background-image: -webkit-named-image(apple-pay-logo-black);\n        background-color: white;\n    }\n    .apple-pay-button-white-with-line {\n        background-image: -webkit-named-image(apple-pay-logo-black);\n        background-color: white;\n        border: .5px solid black;\n    }\n  }\n"));
					p.type = "text/css", p.styleSheet ? p.styleSheet.cssText = d : p.appendChild(document.createTextNode(d)), e.appendChild(p);
					var h = document.createElement("button");
					h.classList.add("apple-pay-button", "light" === u ? "apple-pay-button-white" : "apple-pay-button-black"), h.id = "apple-pay-button";
					var C = document.createElement("span");
					C.classList.add("logo"), h.appendChild(C), e.appendChild(h);
				})(e, {
					styles: x(r.applePay),
					theme: r.theme
				}), c.applePay = !0, n(c);
			});
		} else a("No wallet payment method is available on this device");
		else a("Container to mount elements was not provided");
	});
}
function I(e) {
	for (; e.firstChild;) e.removeChild(e.firstChild);
}
var z = "payment-request-button", O = "paystackpop-button", j = "pay-with-vault-button";
function N(e) {
	var n = document.createElement("button");
	return n.id = O, n.className = "open-paystack-pop-button", n.innerText = e, n;
}
function U(e) {
	return e.querySelector("#".concat(O));
}
function F() {
...
function D(e, n) {
	var t = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, a = document.querySelector("#pre-checkout-modal-".concat(e));
	if (a) {
		if (U(a) && Z(a)) return a;
		a.remove();
	}
	var i = document.createElement("div");
	i.classList.add("pre-checkout-modal"), i.id = "pre-checkout-modal-".concat(e), i.style.zIndex = E() + 1;
	var o = document.createElement("div");
	o.classList.add("pre-checkout-modal__content"), i.appendChild(o);
	var r = n || {}, c = r.merchant_logo, s = r.merchant_name, l = r.email, u = r.amount, p = r.currency, d = r.label, h = r.channels, C = new Intl.NumberFormat("en", {
		style: "currency",
		currency: p,
		currencyDisplay: "code",
		maximumFractionDigits: 2,
		minimumFractionDigits: 0
	}).format(u / 100), m = document.createElement("div");
	m.classList.add("payment-info"), m.innerHTML = "<img class=\"merchant-logo\" src=\"".concat(c, "\" alt=\"").concat(s, " Logo\">\n    <div class=\"customer-info\">\n      <div class=\"customer-email\">").concat(d || l, "</div>\n      <div class=\"transaction-amount\">Pay <span class=\"amount\">").concat(C, "</span></div>\n    </div>"), o.appendChild(m), o.innerHTML += "\n  <button type=\"button\" id=\"apple-pay-close-button\">\n    <svg width=\"10\" height=\"9\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n      <path\n        d=\"M5.572 4.033L8.89.71a.4.4 0 0 0-.566-.566L5.003 3.459 1.681.145a.4.4 0 0 0-.566.566L4.44 4.033\n      1.115 7.354a.398.398 0 0 0 0 .566.4.4 0 0 0 .566 0l3.322-3.33 3.322 3.33a.4.4 0 0 0 .566-.566L5.57 4.033z\"\n        fill=\"white\"\n      />\n    </svg>\n  </button>\n";
	var y = document.createElement("div");
	y.classList.add("modal-wrapper"), t.canPayWithVault ? B(y, {
		canPayWithApplePay: t.canPayWithApplePay,
		hasOtherPaymentMethods: R(h)
	}) : function(e, n) {
		var t = n.hasOtherPaymentMethods, a = document.createElement("div");
	...
	if (n && String(n.merchant_id) === String(550652)) {
		var v = document.createElement("iframe");
		v.id = "pre-checkout-modal-iframe-".concat(e), v.setAttribute("allow", "payment"), v.style.cssText = [
			"position: fixed",
			"top: 0",
			"left: 0",
			"width: 100%",
			...
			"background: transparent",
			"z-index: ".concat(E() + 1)
		].join(";"), document.body.appendChild(v);
		var g = v.contentDocument || v.contentWindow.document;
		g.body.style.margin = "0", g.head.appendChild(f), g.body.appendChild(i), i.remove = function() {
			return v.remove();
		};
	} else document.body.appendChild(f), document.body.appendChild(i);
	return i;
}
var W = [
	{
...
function J(e) {
	return (null == e ? void 0 : e.length) > 500 ? e.split("?")[0] : e;
}
function K(e) {
	var n, t, a, i, o = r({}, e);
	o.metadata = e.metadata || {}, o.metadata.referrer = (n = window.location, t = n.href, a = void 0 === t ? "" : t, i = n.ancestorOrigins, [a].concat(l(void 0 === i ? [] : i)).map(J).join(",")), o.metadata = JSON.stringify(o.metadata), o.mode = "popup", e.split && "string" != typeof e.split && (o.split = JSON.stringify(o.split));
	return void 0 !== o.card && ["false", !1].indexOf(o.card) > -1 && (o.channels = ["bank"], delete o.card), void 0 !== o.bank && ["false", !1].indexOf(o.bank) > -1 && (o.channels = ["card"], delete o.bank), [
		{
			to: "firstname",
			from: "firstName"
		},
		...
		o[e.from] && (o[e.to] = o[e.from], delete o[e.from]);
	}), Object.values(e).forEach(function(n, t) {
...
var Q = [
	...
	"iPhone",
	"iPod"
], G = window && window.navigator && (window.navigator.platform || window.navigator.userAgentData && window.navigator.userAgentData.platform), Y = function() {
	var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = e.platform, t = e.userAgent, a = void 0 === t ? window && window.navigator && window.navigator.userAgent : t, i = n || G;
	return Q.includes(i) || a.includes("Mac") && "ontouchend" in document;
}, X = function(e, n, t) {
	var a = "".concat(y.paystackApiUrl, "transaction/update_log/").concat(e), i = { Authorization: "Bearer ".concat(n) };
	return fetch(a, {
		method: "POST",
		body: JSON.stringify({ payload: JSON.stringify(t) }),
		headers: i
	});
}, $ = function(e, n) {
	var t = "".concat(y.paystackApiUrl, "transaction/set_ip/").concat(e), a = { Authorization: "Bearer ".concat(n) };
	return fetch(t, {
		method: "POST",
		headers: a
	});
}, ee = {
	initializeLog: function(e) {
		var n = e || {}, t = n.attempts, a = n.authentication, i = n.errors, o = n.history;
		this.log = {
	...
	getTimeSpent: function() {
		...
		return this.log.time_spent = e - this.log.start_time, this.log.time_spent;
	},
	logAPIResponse: function(e, n) {
		switch (e.status) {
			case "success": return this.logApiSuccess(n);
			case "failed": return this.logApiError(e.message);
			default: return !1;
		}
	},
	logValidationResponse: function(e) {
	...
	logAttempt: function(e) {
		var n = "Attempted to pay";
		return e && (n += " with ".concat(e)), this.log.attempts += 1, this.log.history.push({
			type: "action",
			message: n,
			time: this.getTimeSpent()
		}), this.saveLog();
	...
	logApiError: function(e) {
		var n = "Error";
		return e && (n += ": ".concat(e)), this.log.errors += 1, this.log.history.push({
			type: "error",
			message: n,
			time: this.getTimeSpent()
		}), this.saveLog();
	},
	logApiSuccess: function(e) {
		var n = "Successfully paid";
		return e && (n += " with ".concat(e)), this.log.success = !0, this.log.history.push({
			type: "success",
			message: n,
			time: this.getTimeSpent()
		}), this.saveLog();
	...
	saveLog: function() {
		try {
			if (this.response) return X(this.id, this.response.merchant_key, this.log);
		} catch (e) {}
	},
	saveIpAddress: function() {
		try {
			if (this.response) return $(this.id, this.response.merchant_key);
		} catch (e) {}
	}
}, ne = ["language", "connect_account"], te = { requestInline: function() {
	var e = this, n = this.urlParameters, t = n.language, a = n.connect_account, i = c(n, ne), o = r({ "Content-Type": "application/json" }, t && { "Accept-Language": t });
	return (this.accessCode ? fetch(new URL("transaction/verify_access_code/".concat(this.accessCode), y.paystackApiUrl).toString(), { headers: o }) : fetch(new URL("/checkout/request_inline", y.paystackApiUrl).toString(), {
		method: "POST",
		body: JSON.stringify(i),
		headers: r(r({}, o), a && { "x-connect-account": a })
	})).then(function(e) {
		return e.json();
	}).then(function(n) {
		if (!1 === n.status) throw new Error(n.message);
		return e.response = n.data, e.id = n.data.id, e.status = n.data.transaction_status, e.accessCode = n.data.access_code, e.log = null, Object.assign(e, ee), e.initializeLog(n.data.log), e.saveIpAddress(), n.data;
	});
} }, ae = function() {
	return a(function e(t) {
		n(this, e), function(e) {
			function n(e, n) {
				this.message = e, this.issues = n || [];
			}
			if (!e || "object" !== p(e)) throw new n("Transaction parameters should be a non-empty object");
			var t = e;
			if ("accessCode" in t) return { accessCode: t.accessCode };
			Object.keys(t).forEach(function(e) {
				void 0 !== W.find(function(n) {
					return n.value === e;
				}) || delete t[e];
			});
			var a = Object.keys(t), i = [];
			if (W.filter(function(e) {
				return e.required;
			}).forEach(function(e) {
				var n = !t[e.value], a = e.or ? e.or.some(function(e) {
					return t[e];
				}) : null;
				n && !a && i.push({ message: "Required parameter missing: ".concat(e.value) });
			}), a.forEach(function(e) {
				var n = t[e], a = W.find(function(n) {
					return n.value === e;
				}), o = p(n);
				"object" === o && Array.isArray(n) && (o = "array"), a.types.indexOf(o) <= -1 && i.push({
					message: "Invalid parameter type: ".concat(e),
					validTypes: a.types
				});
			}), a.forEach(function(e) {
				var n = W.find(function(n) {
					return n.value === e;
				});
				n.override && delete t[n.override];
			}), i.length) throw new n("Invalid transaction parameters", i);
		}(t), this.parameters = t, this.urlParameters = K(t), this.id = null, this.status = null, this.accessCode = t.accessCode || null, this.authorizationUrl = null, this.errors = [], this.response = null, this.isActive = !0;
		var a = t.onError, i = t.onLoad, o = t.onSuccess, r = t.onCancel, c = t.callback, s = t.onClose, l = t.onBankTransferConfirmationPending;
		this.callbacks = {
			onError: a,
			onLoad: i,
			onSuccess: o,
			onCancel: r,
			onBankTransferConfirmationPending: l
		}, this.deprecatedCallbacks = {
			callback: c,
			onClose: s
		}, Object.assign(this, te);
	}, [
		{
			key: "onSetupError",
			value: function(e) {
		...
		},
		{
			key: "onLoad",
			value: function(e) {
				var n = e.id, t = e.customer, a = e.accessCode;
				Object.assign(this, {
					id: n,
					customer: t,
					accessCode: a
				}), this.authorizationUrl = "".concat(y.checkoutUrl).concat(a), this.callbacks.onLoad && this.callbacks.onLoad({
					id: n,
					customer: t,
					accessCode: a
				});
...
}(), ie = console ? console.warn || console.log : function() {};
function oe(e, n, t) {
	ie("\"".concat(e, "\" has been deprecated, please use \"").concat(n, "\". ").concat(t || ""));
}
var re, ce = [
	"preload",
	"inlineTransaction",
...
function le(e, n) {
	...
	var t = e.filter(function(e) {
		var t, a, i, o, r = !e.status || "abandoned" === e.status, c = (t = e.parameters, a = n, i = Object.keys(t).sort().join("") === Object.keys(a).sort().join(""), o = Object.values(t).sort().join("") === Object.values(a).sort().join(""), i && o);
		return r && c;
	});
	return t.length ? t[t.length - 1] : null;
}
function ue(e) {
	var n = e.checkoutIframe, t = e.urlParameters;
	n && t && n.contentWindow.postMessage({
		type: "inline:url",
		path: "newTransaction",
		params: t
	}, "*");
}
var pe = "trackCheckoutClosed", de = "trackPaymentError", he = "trackPaymentAttempt", Ce = "trackPaymentCompletion";
function me(e) {
	throw ie(e), new Error(e);
}
var ye, fe, ve = function() {
	function e(t) {
		var a, i;
		n(this, e), this.id = function() {
			for (var e = "", n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", t = 0; t < 5; t += 1) e += n.charAt(Math.floor(62 * Math.random()));
			return e;
		}(), this.transactions = [], this.isOpen = !1, this.isLoaded = !1, this.isDeprecatedApi = t && t.isDeprecatedApi, t && t.isEmbed ? this.isEmbed = !0 : t && t.isPaymentRequest && (t.container && q(t.container) || me("A container is required to mount the payment request button"), this.paymentRequestContainer = q(t.container), this.paymentRequestTransaction = null), this.preCheckoutModal = null, this.backgroundIframe = function(e) {
			var n = A("inline-background-".concat(e));
			n.style.cssText = "\n  z-index: 999999999999999;\n  background: transparent;\n  background: rgba(0, 0, 0, 0.75);    \n  border: 0px none transparent;\n  overflow-x: hidden;\n  overflow-y: hidden;\n  margin: 0;\n  padding: 0;\n  -webkit-tap-highlight-color: transparent;\n  -webkit-touch-callout: none;\n  position: fixed;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  transition: opacity 0.3s;\n  -webkit-transition: opacity 0.3s;\n  visibility: hidden;\n  display: none;\n", n.style.colorScheme = "light", document.body.appendChild(n);
		...
		}(this.id), this.checkoutIframe = (a = this.id, (i = A("inline-checkout-".concat(a))).src = "".concat(y.checkoutUrl, "popup"), i.style.cssText = "\n  z-index: 999999999999999;\n  background: transparent;\n  border: 0px none transparent;\n  overflow-x: hidden;\n  overflow-y: hidden;\n  margin: 0;\n  padding: 0;\n  -webkit-tap-highlight-color: transparent;\n  -webkit-touch-callout: none;\n  position: fixed;\n  left: 0;\n  top: 0;\n  width: 100%;\n  visibility: hidden;\n  display: none;\n  height: 100%;\n", i.style.colorScheme = "light", i.setAttribute("allowpaymentrequest", "true"), i.setAttribute("allow", "payment; clipboard-read; clipboard-write"), document.body.appendChild(i), i), this.registerListeners();
	}
	return a(e, [
		{
			...
			value: function() {
				...
				window.addEventListener("message", function(n) {
					var t = "".concat(n.origin, "/") === y.checkoutUrl, a = e.checkoutIframe && e.checkoutIframe.contentWindow === n.source, i = e.isEmbed;
					t || a ? e.respondToEvent(n) : i && e.respondToEmbedEvents(n);
				});
			}
		},
		{
		...
		},
		{
			key: "checkout",
			value: function(e) {
				this.activeTransaction() && this.activeTransaction().cancel(), re = this;
				var n = le(this.transactions, e) || new ae(e);
				return new Promise(function(e, t) {
					n.requestInline().then(function(t) {
						var a = function() {
							var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = e.platform, t = e.userAgent, a = void 0 === t ? window && window.navigator && window.navigator.userAgent : t, i = n || G, o = a && !!a.match(/Version\/[\d.]+.*Safari/), r = i && /(Mac)/i.test(i);
							return Y() || r && o;
						}() && S(t.channels), i = function() {
							var e, n, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
							return !(null === (e = t.link_config) || void 0 === e || !e.enabled || null === (n = t.link_config) || void 0 === n || !n.has_payment_instruments);
						}(t);
						i || a ? (re.preloadTransaction({
							inlineTransaction: n,
							transactionData: t
						}), re.preCheckoutModal = D(re.id, t, {
							canPayWithVault: i,
							canPayWithApplePay: a
						}), a ? (re.paymentRequestContainer = Z(re.preCheckoutModal), H(re.paymentRequestContainer, {
							channels: t.channels,
							styles: { applePay: {
								width: "100%",
								type: "pay",
							...
							re.registerPaymentRequestEventListeners();
						}).catch(function() {
							i ? Z(re.preCheckoutModal).remove() : (re.closePreCheckoutModal(), re.animateCheckoutIn());
						}).finally(function() {
							e(n);
						})) : e(n)) : (re.newTransaction({
							inlineTransaction: n,
							transactionData: t
						}), e(n));
					}).catch(function(e) {
		...
		},
		{
			...
			value: function() {
				var e;
				this.registerPreCheckoutModalEventListeners(), e = this.preCheckoutModal, new Promise(function(n, t) {
					try {
		...
		},
		{
			...
			value: function() {
				var e, n = this, t = !1, a = this.activeTransaction();
				document.addEventListener("touchstart", function(n) {
					n.preventDefault(), t || (t = !0, e = setTimeout(function() {
						t = !1;
					}, 125));
				}, !0), document.addEventListener("touchend", function(n) {
					n.target && n.target.isSameNode(re.preCheckoutModal) && t && (clearTimeout(e), re.closePreCheckoutModal(), a && a.cancel()), t = !1;
				}, !0);
				var i = U(this.preCheckoutModal);
				i && (i.onclick = function() {
					n.closePreCheckoutModal(), n.animateCheckoutIn();
				});
				var o = this.preCheckoutModal.querySelector("#".concat(j));
				...
				var r = function(e) {
					return e.querySelector("#apple-pay-close-button");
				}(this.preCheckoutModal);
				r.onclick = function() {
					n.sendAnalyticsEventToCheckout(pe), n.closePreCheckoutModalAndCancelTransaction();
				};
			}
		},
		{
		...
		},
		{
			key: "newTransaction",
			value: function(e) {
				var n = e.preload, t = e.inlineTransaction, a = e.transactionData, i = c(e, ce), o = this.paymentRequestContainer && T(this.paymentRequestContainer);
				if (this.activeTransaction() && !o && this.activeTransaction().cancel(), t && a) return this.transactions.push(t), this.isDeprecatedApi || this.open({
					accessCode: a.access_code,
					language: t.urlParameters.language
				}, n), t;
				var r = le(this.transactions, t ? t.parameters : i);
				if (r) return r.isActive = !0, this.isDeprecatedApi || this.open({
					accessCode: r.accessCode,
					language: r.urlParameters.language
				}, n), r;
				var s = t || new ae(i), l = s.accessCode ? {
					accessCode: s.accessCode,
					language: s.urlParameters.language
				} : s.urlParameters;
				return this.transactions.push(s), this.isDeprecatedApi || this.open(l, n), s;
			}
		},
		{
			...
			value: function(e) {
				var n = this;
				this.newTransaction(r(r({}, e), {}, { preload: !0 }));
				return function() {
		...
		},
		{
			key: "paymentRequest",
			value: function(e) {
				var n = e.container, t = e.styles, a = e.onElementsMount, i = c(e, se);
				return re = this, new Promise(function(o, r) {
					var c = document.querySelector("#".concat(e.loadPaystackCheckoutButton));
					if (_()) {
						re.activeTransaction() && re.activeTransaction().cancel(), n && q(n) || me("A container is required to mount the payment request button"), re.paymentRequestContainer = q(n);
						var s = le(re.transactions, i), l = s || new ae(i);
						l.requestInline().then(function(e) {
							H(re.paymentRequestContainer, {
								channels: e.channels,
								styles: t
							}, e.merchant_id).then(function(e) {
								a && a(e);
							}).catch(function() {
								a && a(null);
							}).finally(function() {
								if (s ? l.isActive = !0 : re.transactions.push(l), re.registerPaymentRequestEventListeners(), c) c.onclick = re.preloadTransaction({
									inlineTransaction: l,
									transactionData: e
								});
								o(l);
						...
						if (e && e.loadPaystackCheckoutButton) if (c) c.onclick = re.preloadTransaction(i);
						else ie("This device does not support any payment request wallet options. Please consult our documentation at https://developers.paystack.co/docs/paystack-inline to see how to load alternative payment options using 'loadPaystackCheckoutButton'");
						a && a(null);
						o(re.activeTransaction());
					}
				});
			}
		},
		{
			...
			value: function() {
				var e = this;
				T(this.paymentRequestContainer).onclick = function() {
		...
		},
		{
			...
			value: function() {
				...
				e && S(e.response.channels) ? this.registerApplePayEventListener() : I(this.paymentRequestContainer);
			}
		},
		{
			key: "startApplePay",
			value: function() {
				var e, n, t, a, i, o = this, c = "apple pay", s = this.activeTransaction();
				if (s) {
					var l = {
						channel: "apple_pay",
						paymentMethod: c,
					...
					try {
						s.logAttempt(c), this.sendAnalyticsEventToCheckout(he, l);
						var p = (e = {
						...
						}, n = e.currency, t = e.amount, a = e.merchantName, i = e.interval, r({
							countryCode: "NG",
							currencyCode: n,
							...
							total: {
								label: "".concat(a, " - Paystack"),
								type: "final",
								amount: String(M(t))
							}
						}, "string" == typeof i && "" !== i.trim() && { lineItems: [{
							label: L(i),
							amount: String(M(t))
						}] })), d = new window.ApplePaySession(y.applePayVersion, p);
						d.onvalidatemerchant = function(e) {
							(function(e) {
								var n = e.transactionId, t = e.validationURL, a = e.merchantName, i = e.domainName, o = void 0 === i ? window && window.location && window.location.hostname : i, c = "".concat(y.paymentBaseUrl).concat(y.applePayValidateSessionPath), s = V({
									transaction: n,
									sessionUrl: t,
									displayName: a,
									domainName: o
								});
								return fetch(c, r(r({}, P), {}, { body: s })).then(function(e) {
									return e.json();
								});
							})({
								...
								"success" !== e.status ? s.onSetupError(e) : d.completeMerchantValidation(e.data), s.logValidationResponse(e.message);
							}).catch(function(e) {
								s.onSetupError(e);
							});
						}, d.oncancel = function() {
							re.preCheckoutModal || s.onCancel();
						}, d.onpaymentauthorized = function(e) {
							var n = e.payment;
							(function(e) {
								var n = e.transactionId, t = e.payment, a = "".concat(y.paymentBaseUrl).concat(y.applePayChargePath), i = V({
									transaction: n,
									paymentObject: JSON.stringify(t)
								});
								return fetch(a, r(r({}, P), {}, { body: i })).then(function(e) {
									return e.json();
								});
							})({
								transactionId: s.id,
								...
								s.logAPIResponse(e, c), "success" === e.status ? (d.completePayment(d.STATUS_SUCCESS), s.onSuccess(e), o.sendAnalyticsEventToCheckout(Ce, u)) : (d.completePayment(d.STATUS_FAILURE), s.onSetupError(e), o.sendAnalyticsEventToCheckout(de, {
									channel: "apple_pay",
									message: e && e.message || "Transaction attempt failed"
								})), re.closePreCheckoutModal(e.status);
							}).catch(function(e) {
								d.completePayment(d.STATUS_FAILURE), s.onSetupError(e), o.sendAnalyticsEventToCheckout(de, {
									channel: "apple_pay",
									message: e && e.message || "Error occurred"
								}), re.closePreCheckoutModal("failed");
							});
						}, d.begin();
					} catch (e) {
						s.onSetupError(e);
					}
				} else me("Could not initiate apple pay transaction");
			}
		},
		{
			key: "resumeTransaction",
			value: function(e) {
				var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, t = n.onSuccess, a = n.onCancel, i = n.onLoad, o = n.onError;
		...
		},
		{
			...
			value: function() {
				var e = this.transactions.filter(function(e) {
					return e.isActive;
				});
		...
		},
		{
			...
			value: function(e) {
				var n = this.transactions.find(function(n) {
					return n.id === e;
		...
		},
		{
			...
			value: function(e) {
				if (e) {
					var n, t, a = this.activeTransaction();
					try {
						var i = e.data || e.message, o = i.event, r = i.data;
						if (o) switch (o) {
							case "loaded:checkout":
								if (this.isLoaded = !0, a) {
									var c = this.checkoutIframe, s = a.urlParameters, l = a.response;
									ue({
										checkoutIframe: c,
										urlParameters: l ? {
											accessCode: l.access_code,
											language: null == s ? void 0 : s.language
										} : s
									});
								}
								break;
							case "loaded:transaction":
								n = this.backgroundIframe, (t = n.contentWindow.document) && (t.getElementById("app-loader").style.display = "none"), this.preCheckoutModal && this.openPreCheckoutModal(), a.onLoad(r);
								break;
							case "error":
							...
							case "close":
								this.close();
								var u = r && r.status;
								u && a.setStatus(u), !(this.paymentRequestContainer && T(this.paymentRequestContainer) && !this.preCheckoutModal) && (a.isActive = !1), a.onCancel();
								break;
							case "transfer:pending":
								this.close();
								var p = r && r.status;
								p && a.setStatus(p), a.onBankTransferConfirmationPending();
								break;
							case "success": this.close(), a.onSuccess(r);
						}
					} catch (e) {}
				}
			}
		},
		{
			...
			value: function(e) {
				var n, t, a = this.activeTransaction(), i = e.data || e.message;
				if (i && ("string" == typeof i || i instanceof String)) {
					var o = {
						action: t = (n = i) && "string" == typeof n ? n.split(" ")[0] : null,
						data: t ? n.split(" ").slice(2).join(" ") : null
					};
					if (o && "PaystackClose" === o.action) o.data && a.onSuccess(i);
					"PaystackTLSClose" === o.action && a.cancel();
				}
			}
		},
		{
			...
			value: function() {
				...
				if (!this.isOpen) (e = {
					...
					var a = e.checkoutIframe, i = e.backgroundIframe;
					a && i || t("No dom element provided"), a.style.display = "", a.style.visibility = "visible", i.style.display = "", i.style.visibility = "visible", n();
				})).then(function() {
			...
			value: function() {
				...
				if (this.isOpen) {
					...
					(n = {
						...
						var a = n.checkoutIframe, i = n.backgroundIframe;
						a && i || t("No dom element provided"), i.style.opacity = 0, a.style.display = "none", a.style.visibility = "hidden", setTimeout(function() {
							i.style.display = "none", i.style.visibility = "hidden", i.style.opacity = 1, e();
						}, 300);
					})).then(function() {
		...
		value: function(n) {
			...
			re || (re = new e({
				isDeprecatedApi: !0,
				isEmbed: t
			})), oe("PaystackPop.setup()", "new PaystackPop()", "Please consult our documentation at https://developers.paystack.co/docs/paystack-inline");
			var a = re.newTransaction(n, "deprecated"), i = a.urlParameters;
			if (t) {
				var o = "".concat(y.siteUrl, "/assets/payment/production/inline.html?").concat(f(i)), r = function(e, n) {
					var t = A("embed-checkout-".concat(e));
					return t.style.cssText = "\n  background: transparent;\n  background: rgba(0,0,0,0);\n  border: 0px none transparent;\n  overflow-x: hidden;\n  overflow-y: hidden;\n  nmargin: 0;\n  padding: 0;\n  -webkit-tap-highlight-color: transparent;\n  -webkit-touch-callout: none;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  visibility: hidden;\n  display: none;\n", t.src = n, t.id = e, t.name = e, t.setAttribute("allowpaymentrequest", "true"), t.setAttribute("allow", "payment; clipboard-read; clipboard-write"), t;
				}(re.id, o);
				(function(e, n) {
					var t = document.getElementById(e);
					t.innerHTML = "", t.removeAttribute("style"), t.className = "paystack-embed-container", t.style.position = "relative", t.style.width = "100%", t.appendChild(n);
				})(n.container, r), r.onload = function() {
					var e;
					r.contentWindow.postMessage("PaystackOpen ".concat(re.id), "*"), e = r, new Promise(function(n, t) {
						e || t("No dom element provided"), e.style.display = "", e.style.visibility = "visible", n();
					});
				};
			} else a.openIframe = function() {
				oe("openIframe", "open", "Please consult our documentation at https://developers.paystack.co/docs/paystack-inline"), re.open(i);
			};
			return a;
		}
	}]);
}();
if (ye = b().length > 0, fe = g() && "FORM" === g().parentElement.tagName, ye && fe) {
	var ge, be = function() {
		var e = {}, n = g();
		return b().forEach(function(t) {
			var a = n.getAttribute(t), i = t.split("data-")[1].replace(/-([a-z])/g, function(e) {
				return e[1].toUpperCase();
			});
			e[i] = a;
		}), function(e) {
			if (e.buttonId && !document.getElementById(e.buttonId)) throw new Error("Please make sure the buttonId is an element available in the DOM");
			var n = r({}, e);
			n.buttonText = e.buttonText || "Pay", n.buttonVariant = "normal", n.buttonWordmarkVariant = "normal";
			var t = ["normal", "light"];
			return e.buttonVariant && t.indexOf(e.buttonVariant) > -1 && (n.buttonVariant = e.buttonVariant), e.buttonWordmarkVariant && t.indexOf(e.buttonWordmarkVariant) > -1 && (n.buttonWordmarkVariant = e.buttonWordmarkVariant), n;
		}(e);
	}(), ke = g().parentElement;
	re || (re = new ve()), function(e) {
		var n;
		if (e.id) (n = document.getElementById(e.id)).setAttribute("data-inline-id", e.id);
		else {
			var t = document.createElement("div");
			t.id = "inline-button-".concat(e.inlineId), t.innerHTML = function(e) {
				var n, t, a = {
					normal: "\n  <svg id=\"inline-button-wordmark\" width=\"137\" height=\"13\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n    <path d=\"M.037 5.095l1.075-.135c-.011-.774-.025-1.944-.013-2.149C1.19 1.364 2.38.134 3.81.013 3.9.006 3.99.002 4.077 0a2.947 2.947 0 0 1 2.046.76c.574.509.95 1.26 1.008 2.007.015.192.01 1.491.01 2.257l1.096.163L8.2 11.44 4.093 12 0 11.346l.037-6.251zm4.106-.514l1.724.256c-.007-.933-.05-2.295-.26-2.654-.319-.545-.846-.867-1.443-.88h-.063c-.607.008-1.138.322-1.458.864-.222.378-.266 1.66-.265 2.637l1.765-.223zM18.228 10.108c-.576 0-1.064-.072-1.464-.216a2.864 2.864 0 0 1-.972-.6 2.552 2.552 0 0 1-.588-.864 4.067 4.067 0 0 1-.252-1.044h1.008c.032.256.088.5.168.732.08.224.204.424.372.6.168.168.388.304.66.408.28.096.636.144 1.068.144.28 0 .536-.036.768-.108.24-.08.448-.192.624-.336.176-.144.312-.316.408-.516.104-.2.156-.42.156-.66 0-.24-.032-.448-.096-.624a1.02 1.02 0 0 0-.336-.468 1.885 1.885 0 0 0-.636-.324 6.4 6.4 0 0 0-1.008-.228 8.79 8.79 0 0 1-1.212-.276 3.246 3.246 0 0 1-.9-.432 1.982 1.982 0 0 1-.564-.672c-.128-.272-.192-.6-.192-.984 0-.328.068-.632.204-.912.136-.288.324-.536.564-.744.248-.208.54-.372.876-.492.336-.12.708-.18 1.116-.18.864 0 1.548.204 2.052.612.512.4.812.984.9 1.752h-.936c-.104-.544-.316-.932-.636-1.164-.32-.24-.78-.36-1.38-.36-.592 0-1.04.132-1.344.396a1.255 1.255 0 0 0-.444.996c0 .208.
0 0 0-1.18-1.127c-.504-.291-1.108-.441-1.784-.441a3.519 3.519 0 0 0-2.51 1.033c-.322.322-.576.71-.747 1.137a3.68 3.68 0 0 0-.273 1.407c0 .495.093.968.273 1.402.173.424.427.808.747 1.128a3.527 3.527 0 0 0 2.51 1.034c.676 0 1.28-.149 1.784-.444a3.286 3.286 0 0 0 1.182-1.13.411.411 0 0 0 .055-.173.415.415 0 0 0-.023-.182.624.624 0 0 0-.197-.273zM136.06 9.045l-2.104-3.143 1.801-2.415c.094-.139.119-.272.075-.397-.031-.09-.116-.2-.334-.2h-1.425a.52.52 0 0 0-.234.058.482.482 0 0 0-.209.205L132.191 5.2h-.349V.363a.37.37 0 0 0-.099-.26.352.352 0 0 0-.253-.103h-1.332a.37.37 0 0 0-.337.22.346.346 0 0 0-.027.143V9.29c0 .103.038.193.11.259a.353.353 0 0 0 .254.104h1.333a.328.328 0 0 0 .251-.105.346.346 0 0 0 .075-.119.333.333 0 0 0 .024-.14V6.927h.386l1.571 2.446c.112.187.267.281.46.281h1.491c.226 0 .32-.11.358-.202.054-.13.038-.262-.047-.406zM102.863 2.89h-1.489a.389.389 0 0 0-.298.122.544.544 0 0 0-.13.249l-1.099 4.167h-.268l-1.182-4.167a.66.66 0 0 0-.113-.247.329.329 0 0 0-.264-.124h-1.544c-.199 0-.325.066-.372.193a.588.588 0 0 0-.002.37l1.887 5.865c.03.093.08.17.145.232a.388.388 0 0 0 .281.104h.798l-.066.19-.19.547a.872.872 0 0 1-.29.426.7.7 0 0 1-.442.148.956.956 0 0 1-.4-.09 1.842 1.842 0 0 1-.35-.209.62.62 0 0 0-.335-.115h-.016c-.13 0-.243.074-.334.216l-.474.708c-.193.304-.086.504.039.615.234.224.528.399.875.524.344.125.723.186 1.126.186.682 0 1.252-.187 1.689-.565.435-.376.756-.887.952-1.524l2.188-7.258c.05-.155.05-.284.005-.389-.037-.08-.125-.174-.327-.174z\" fill=\"#011B33\"/>\n    </svg>",
					light: k
				};
				return "\n    <style>\n      #inline-button-".concat(e.inlineId, " {\n        position: relative;\n        text-align: center;\n        display: inline-block;\n      }\n      #inline-button-").concat(e.inlineId, "__trigger {\n        ").concat((n = e.variant || "normal", t = {
			...
			}(e), e.parent.parentNode.insertBefore(t, e.parent.nextSibling), n = s(t.getElementsByTagName("button"), 1)[0];
		}
		return n;
	}({
		inlineId: re.id,
		amount: be.amount / 100,
		currency: be.currency,
		id: be.buttonId,
		text: be.buttonText,
		variant: be.buttonVariant,
		wordmarkVariant: be.buttonWordmarkVariant,
		parent: g()
	}).addEventListener("click", function(e) {
		e.preventDefault(), ge ? re.resumeTransaction(ge.accessCode) : ge = re.newTransaction(r(r({}, be), {}, { onSuccess: function(e) {
			var n = {
				type: "hidden",
				name: "reference",
				value: e.reference,
				parent: ke
			}, t = n.type, a = n.value, i = n.name, o = n.parent, r;
			(r = document.createElement("input")).type = t, r.value = a, r.name = i, o.appendChild(r), ke.submit();
		} }));
	});
}
//#endregion
